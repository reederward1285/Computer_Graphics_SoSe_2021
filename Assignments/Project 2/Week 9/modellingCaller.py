...
class ModellingCaller(FigureCanvas):
    ...
    def scaleMesh(self, factor, axyz):
        ...
        """
        # save points and tris from last step
        self.mesh.oldpts = deepcopy(self.mesh.pts)
        self.mesh.oldtris = deepcopy(self.mesh.tris)
    ...
    def undoStep(self):
        self.mesh.pts = deepcopy(self.mesh.oldpts)
        self.mesh.tris = deepcopy(self.mesh.oldtris)
